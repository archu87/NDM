...
myfiles = do.call(rbind, lapply(files, function(x) read.delim(x, stringsAsFactors = FALSE, skip=12, nrows=68, header=TRUE)))
...
write.table(total_FastQC, "total_FastQC.txt", sep="\t")
